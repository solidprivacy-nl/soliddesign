...
def run_component_spike(prospect: Prospect, audit: AuditResult, qualification_input: QualificationInput, output_dir: str | Path, *, preview_url: str) -> dict:
...
def run_golden_fixture(fixture_dir: str | Path, output_dir: str | Path, *, preview_url: str = "https://preview.example.invalid/p/golden") -> dict:
    ...
    return run_component_spike(prospect, audit, q_input, output_dir, preview_url=preview_url)
